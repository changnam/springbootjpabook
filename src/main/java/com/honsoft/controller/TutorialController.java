...
public class TutorialController {
  ...
  @GetMapping("/tutorialsByService")
  public List<Tutorial> getAllByEm(){
	  return tutorialService.getAll();
  }
  
  @GetMapping("/tutorialsByService2")
  public List<Tutorial> getAllByMapper(){
	  return tutorialService.getAllByMapper();
  }
 
  @GetMapping("/tutorialsByService3")
  public List<Tutorial> getAllByJdbcTemplate(){
	  return tutorialService.getAllByJdbcTemplate();
  }
  
  @GetMapping("/tutorialsByService4")
